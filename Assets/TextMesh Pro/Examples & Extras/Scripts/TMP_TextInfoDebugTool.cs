...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        /// <summary>
        /// Method to draw a rectangle around each health_Source.
        /// </summary>
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Get Bottom Left and Top Right position of the current health_Source
        ...
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                // Iterate through each health_Source of the word
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debug.Log("Start Word Region at [" + currentCharInfo.health_Source + "]");

                        // If Word is one health_Source
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debug.Log("End Word Region at [" + currentCharInfo.health_Source + "]");
                        }
                    }
        ...
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each health_Source of the link text
